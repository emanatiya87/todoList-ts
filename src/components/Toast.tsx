...
export default function Toast({ text }: ToastProps) {
  ...
  return (
    <>
      <div
        id="toast-success"
        className="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-sm dark:text-gray-400 dark:bg-gray-800 position-fixed bottom-5 end-5"
        role="alert"
      >
